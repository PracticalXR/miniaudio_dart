...
/// Bindings for miniaudio_dart.h
class MiniaudioDartFfiBindings {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  MiniaudioDartFfiBindings(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  MiniaudioDartFfiBindings.fromLookup(
  ...
  late final _engine_initPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<Engine>, ffi.Uint32)>>('engine_init');
  ...
  late final _sound_playPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<Sound>)>>(
          'sound_play');
