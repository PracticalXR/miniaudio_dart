"""
Release Management Script for miniaudio_dart Package Family

This script manages version updates and changelog entries across all packages in the miniaudio_dart repository.
...
2. ADD CHANGELOG MESSAGES:
   ...
   - python release.py change "created abc functionality" miniaudio_dart_ffi
     → Adds message only to miniaudio_dart_ffi changelog current version
   
   - python release.py change "updated API" miniaudio_dart_ffi,miniaudio_dart
...
PACKAGES = ["miniaudio_dart", "miniaudio_dart_platform_interface", "miniaudio_dart_ffi", "miniaudio_dart_web"]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Manage versioning, changelogs, and publishing for miniaudio_dart packages.",
